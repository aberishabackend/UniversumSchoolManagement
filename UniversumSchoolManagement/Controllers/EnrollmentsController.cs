...
namespace UniversumSchoolManagement.Controllers
{
    ...
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(UniversumDbContext context)
        {
            _context = context;
        }
        ...
        {
            var universumDbContext = _context.Enrollments.Include(e => e.Class).Include(e => e.Student);
            return View(await universumDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UniversumDbContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
