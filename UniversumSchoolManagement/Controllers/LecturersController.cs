...
namespace UniversumSchoolManagement.Controllers
{
    ...
    public class LecturersController : Controller
    {
        ...
        public LecturersController(UniversumDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Lecturers != null ?
                        ...
                        Problem("Entity set 'UniversumDbContext.Lecturers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UniversumDbContext.Lecturers'  is null.");
            }
            var lecturer = await _context.Lecturers.FindAsync(id);
            if (lecturer != null)
            {
